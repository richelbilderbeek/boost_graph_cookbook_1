...
BOOST_AUTO_TEST_CASE(
  create_named_edges_and_vertices_path_graph_one_vertex_too_few)
{
...
BOOST_AUTO_TEST_CASE(create_named_edges_and_vertices_path_graph_create_pictures)
{
  ...
  // 'create_named_edges_and_vertices_path_graph' chapter for (const int n: {3,4,
  // 5} )
  ...
  const std::string base_filename{
    "create_named_edges_and_vertices_path_graph_4"
  };
