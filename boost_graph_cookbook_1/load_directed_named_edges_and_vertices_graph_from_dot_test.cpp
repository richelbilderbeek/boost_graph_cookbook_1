...
BOOST_AUTO_TEST_CASE(
  load_directed_named_edges_and_vertices_graph_from_dot_thorough)
{
  // Create the picture
  // 'load_directed_named_edges_and_vertices_graph_from_dot_test_markov_chain.svg'
  ...
  // to .svg
  {
    ...
    const std::string dot_filename{ "load_directed_named_edges_and_vertices_"
...
BOOST_AUTO_TEST_CASE(
  load_directed_named_edges_and_vertices_graph_from_dot_when_file_is_absent)
{
  const std::string dot_filename{ "load_directed_named_edges_and_vertices_"
