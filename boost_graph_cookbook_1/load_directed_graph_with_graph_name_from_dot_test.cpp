...
{
  // Create the picture
  // 'load_directed_graph_with_graph_name_from_dot_test_markov_chain.svg'
  {
...
BOOST_AUTO_TEST_CASE(
  load_directed_graph_with_graph_name_from_dot_when_file_is_absent)
{
  const std::string dot_filename{
    "load_directed_graph_with_graph_name_from_dot_when_file_is_absent.dot"
  };
  assert(!is_regular_file(dot_filename));
  BOOST_CHECK_THROW(load_directed_graph_with_graph_name_from_dot(dot_filename),
