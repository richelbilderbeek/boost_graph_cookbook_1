...
{
  // Create the picture
  // 'load_undirected_bundled_vertices_graph_from_dot_test_k2_graph.svg' Create
  // graphs, save it to dot Create another graph by loading it, then save it to
  // .dot, convert that .dot to .svg
  {
...
BOOST_AUTO_TEST_CASE(
  load_undirected_bundled_vertices_graph_from_dot_when_file_is_absent)
{
