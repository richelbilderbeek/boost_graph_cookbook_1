...
BOOST_AUTO_TEST_CASE(
  create_all_direct_neighbour_custom_and_selectable_edges_and_vertices_subgraphs_k2)
{
  const auto v
...
BOOST_AUTO_TEST_CASE(
  create_all_direct_neighbour_custom_and_selectable_edges_and_vertices_subgraphs_k3)
{
  const auto v
    = create_all_direct_neighbour_custom_and_selectable_edges_and_vertices_subgraphs(
...
BOOST_AUTO_TEST_CASE(
  create_all_direct_neighbour_custom_and_selectable_edges_and_vertices_subgraphs_path_graph)
{
  const auto v
    = create_all_direct_neighbour_custom_and_selectable_edges_and_vertices_subgraphs(
...
BOOST_AUTO_TEST_CASE(
  create_all_direct_neighbour_custom_and_selectable_edges_and_vertices_subgraphs_petersen_graph)
{
  const auto v
    = create_all_direct_neighbour_custom_and_selectable_edges_and_vertices_subgraphs(
