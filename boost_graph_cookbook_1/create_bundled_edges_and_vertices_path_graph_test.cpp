...
BOOST_AUTO_TEST_CASE(create_bundled_edges_and_vertices_path_graph_with_one_vertex_too_few)
{
  ...
  BOOST_CHECK_THROW(
    create_bundled_edges_and_vertices_path_graph(my_bundled_edges, my_bundled_vertexes),
...
BOOST_AUTO_TEST_CASE(create_bundled_edges_and_vertices_path_graph_create_pictures)
{
//Create the .dot and .svg of the 'create_bundled_edges_and_vertices_path_graph' chapter
//for (const int n: {3,4, 5} )
  ...
  const auto g = create_bundled_edges_and_vertices_path_graph(my_bundled_edges, my_bundled_vertexes);
  const std::string base_filename{"create_bundled_edges_and_vertices_path_graph_4"};
