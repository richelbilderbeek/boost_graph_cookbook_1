...
#include "create_empty_undirected_text_vertices_graph_demo.impl"
...
BOOST_AUTO_TEST_CASE(create_empty_undirected_text_vertices_graph_thorough)
{
  const auto g = create_empty_undirected_text_vertices_graph();
