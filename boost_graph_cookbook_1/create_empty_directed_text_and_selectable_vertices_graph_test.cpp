...
#include "create_empty_directed_text_and_selectable_vertices_graph_demo.impl"
...
BOOST_AUTO_TEST_CASE(create_empty_directed_text_and_selectable_vertices_graph_thorough)
{
  //Basic testing
  {
