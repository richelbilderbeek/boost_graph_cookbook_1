...
BOOST_AUTO_TEST_CASE(is_custom_vertices_isomorphic_thorough)
{
  {
    const auto g
      = create_custom_vertices_path_graph({ my_custom_vertex("Alpha"),
        my_custom_vertex("Beta"), my_custom_vertex("Gamma") });
    const auto h
      = create_custom_vertices_path_graph({ my_custom_vertex("Alpha"),
        my_custom_vertex("Beta"), my_custom_vertex("Gamma") });
  ...
  }
  {
    const auto g
      = create_custom_vertices_path_graph({ my_custom_vertex("Alpha"),
        my_custom_vertex("Beta"), my_custom_vertex("Gamma") });
    const auto h
      = create_custom_vertices_path_graph({ my_custom_vertex("Gamma"),
        my_custom_vertex("Beta"), my_custom_vertex("Alpha") });
    BOOST_CHECK(is_custom_vertices_isomorphic(g, h));
  }
  {
    const auto g
    ...
    const auto h
      = create_custom_vertices_path_graph({ my_custom_vertex("Alpha"),
        my_custom_vertex("Gamma"), my_custom_vertex("Beta") });
