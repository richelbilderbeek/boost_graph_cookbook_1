...
BOOST_AUTO_TEST_CASE(create_nasty_directed_custom_and_selectable_edges_and_vertices_graph_save_and_load)
{
  //Create the .dot and .svg of the 'create_nasty_directed_custom_and_selectable_edges_and_vertices_graph' chapter
  {
    const auto g = create_nasty_directed_custom_and_selectable_edges_and_vertices_graph();
    const std::string base_filename{"create_nasty_directed_custom_and_selectable_edges_and_vertices_graph"};
