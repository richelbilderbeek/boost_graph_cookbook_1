...
and use 
\verb;boost::write_graphviz; \index{boost::write_graphviz}
...
Then, a \verb;boost::dynamic_properties; \index{boost::dynamic_properties}
is created with the 
\verb;boost::ignore_other_properties; \index{boost::ignore_other_properties}
...
\verb;boost::read_graphviz; \index{boost::read_graphviz}
