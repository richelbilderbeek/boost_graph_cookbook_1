...
We reproduce the $K_{2}$ with named vertices of 
chapter \ref{subsec:create_named_vertices_k2_graph}, 
...
\lstinputlisting[
  caption = Creating $K_{2}$ as depicted in figure \ref{fig:named_vertices_k2_graph},
...
\verb;create_named_vertices_k2_graph; function 
(algorithm \ref{lst:create_named_vertices_k2_graph}).
