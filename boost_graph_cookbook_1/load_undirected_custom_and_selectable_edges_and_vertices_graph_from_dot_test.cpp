...
//#include
//"create_nasty_undirected_custom_and_selectable_edges_and_vertices_graph.h"
...
BOOST_AUTO_TEST_CASE(
  load_undirected_custom_and_selectable_edges_and_vertices_graph_from_dot_thorough)
{
  // Basic tests: empty graph
  {
    const auto g
      = create_empty_undirected_custom_and_selectable_edges_and_vertices_graph();
    const std::string filename{ "create_empty_undirected_custom_and_selectable_"
                                "edges_and_vertices_graph.dot" };
  ...
  {
    auto g =
  create_nasty_undirected_custom_and_selectable_edges_and_vertices_graph();
    const std::string filename{
      "create_nasty_undirected_custom_and_selectable_edges_and_vertices_graph.dot"
    };
    save_custom_and_selectable_edges_and_vertices_graph_to_dot(g, filename);
    const auto h =
  load_undirected_custom_and_selectable_edges_and_vertices_graph_from_dot(filename);
    BOOST_CHECK(get_sorted_custom_vertex_my_vertexes(g) ==
  get_sorted_custom_vertex_my_vertexes(h));
...
BOOST_AUTO_TEST_CASE(
  load_undirected_custom_and_selectable_edges_and_vertices_graph_from_dot_when_file_is_absent)
{
  const std::string dot_filename{
    "load_undirected_custom_and_selectable_edges_and_vertices_graph_from_dot_"
    "when_file_is_absent.dot"
  };
