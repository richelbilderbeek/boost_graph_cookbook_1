...
BOOST_AUTO_TEST_CASE(create_all_direct_neighbour_named_edges_and_vertices_subgraphs_thorough_graphviz)
{
  //Path
  {
    ...
    for (int i=0; i!=sz; ++i)
    {
      ...
      const std::string base_filename{
        "create_all_direct_neighbour_named_edges_and_vertices_subgraphs_"
        + std::to_string(i)
      };
