...
BOOST_AUTO_TEST_CASE(
  load_undirected_bundled_edges_and_vertices_graph_from_dot_thorough)
{
  ...
  // Create the picture
  // 'load_undirected_bundled_edges_and_vertices_graph_from_dot_test_markov_chain.svg'
  ...
  // to .svg
  {
    ...
    const auto h
      = load_undirected_bundled_edges_and_vertices_graph_from_dot<decltype(
        create_bundled_edges_and_vertices_k3_graph())>(dot_filename);
...
BOOST_AUTO_TEST_CASE(
  load_undirected_bundled_edges_and_vertices_graph_from_dot_when_file_is_absent)
{
  const std::string dot_filename{ "load_undirected_bundled_edges_and_vertices_"
