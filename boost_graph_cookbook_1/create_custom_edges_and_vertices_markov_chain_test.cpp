...
BOOST_AUTO_TEST_CASE(create_custom_edges_and_vertices_markov_chain_thorough)
{
  // Basic tests
  {
    ...
    const std::vector<my_custom_edge> edge_my_edges{ get_my_custom_edges(g) };
    ...
    BOOST_CHECK(edge_my_edges == edge_my_edges);
  }
  // Create the .dot and .svg of the
  // 'create_custom_edges_and_vertices_markov_chain' chapter
  {
    const auto g = create_custom_edges_and_vertices_markov_chain();
