...
BOOST_AUTO_TEST_CASE(
  load_directed_custom_and_selectable_vertices_graph_from_dot_thorough)
{
  // Basic tests: empty graph
  {
    ...
    const auto h
      = load_directed_custom_and_selectable_vertices_graph_from_dot(filename);
...
BOOST_AUTO_TEST_CASE(
  load_directed_custom_and_selectable_vertices_graph_from_dot_when_file_is_absent)
{
  const std::string dot_filename{
    "load_directed_custom_and_selectable_vertices_graph_from_dot_when_file_is_"
    "absent.dot"
  };
