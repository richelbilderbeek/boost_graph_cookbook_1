...
#include "create_empty_undirected_text_and_selectable_vertices_graph_demo.impl"
...
BOOST_AUTO_TEST_CASE(create_empty_undirected_text_and_selectable_vertices_graph_thorough)
{
  //Basic testing
  {
    auto g = create_empty_undirected_text_and_selectable_vertices_graph();
    ...
    add_text_and_selectable_vertex("A",true,g);
    BOOST_CHECK(boost::num_edges(g) == 0);
