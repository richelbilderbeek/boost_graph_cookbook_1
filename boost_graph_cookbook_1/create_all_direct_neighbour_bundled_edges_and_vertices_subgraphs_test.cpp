...
BOOST_AUTO_TEST_CASE(create_all_direct_neighbour_bundled_edges_and_vertices_subgraphs_thorough)
{
  //K2
  {
    const auto v = create_all_direct_neighbour_bundled_edges_and_vertices_subgraphs(create_bundled_edges_and_vertices_k2_graph());
  ...
  //Path
  {
    const auto v = create_all_direct_neighbour_bundled_edges_and_vertices_subgraphs(
    ...
    {
      const auto g = v[i];
      const std::string base_filename{"create_all_direct_neighbour_bundled_edges_and_vertices_subgraphs_" + std::to_string(i)};
  ...
  //Petersen Graph
  {
    const auto v = create_all_direct_neighbour_bundled_edges_and_vertices_subgraphs(create_bundled_edges_and_vertices_petersen_graph());
