...
BOOST_AUTO_TEST_CASE(
  create_nasty_undirected_custom_and_selectable_vertices_graph_thorough)
{
  // Create the .dot and .svg of the
  // 'create_nasty_undirected_custom_and_selectable_vertices_graph' chapter
  {
    const auto g
      = create_nasty_undirected_custom_and_selectable_vertices_graph();
