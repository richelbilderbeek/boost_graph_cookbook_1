...
BOOST_AUTO_TEST_CASE(
  create_custom_and_selectable_vertices_petersen_graph_thorough)
{
  // Basic tests
  {
    const auto g = create_custom_and_selectable_vertices_petersen_graph();
    using vertex_descriptor
      = decltype(create_custom_and_selectable_vertices_petersen_graph())::
        vertex_descriptor;
  ...
  // Create the .dot and .svg of the 'create_k3_graph' chapter
  {
    ...
    const std::string base_filename{
      "create_custom_and_selectable_vertices_petersen_graph"
    };
