...
BOOST_AUTO_TEST_CASE(
  test_add_custom_and_selectable_edge_between_vertices_thorough)
{
  auto g
...
BOOST_AUTO_TEST_CASE(
  test_add_custom_and_selectable_edge_between_vertices_with_another_custom_edge)
{
  ...
  another_graph g;
  const auto from = add_custom_vertex(another_vertex("Bert"), g);
  const auto to = add_custom_vertex(another_vertex("Ernie"), g);
  add_custom_and_selectable_edge_between_vertices(
