...
BOOST_AUTO_TEST_CASE(remove_edge_between_vertices_with_names_where_first_vertex_does_not_exist)
{
  ...
  BOOST_CHECK_THROW(
    remove_edge_between_vertices_with_names(c,b,g),
    std::invalid_argument
  );
}

BOOST_AUTO_TEST_CASE(remove_edge_between_vertices_with_names_where_second_vertex_does_not_exist)
{
  auto g = create_empty_undirected_named_edges_and_vertices_graph();
  const std::string a{"A"};
  const std::string b{"B"};
  ...
  boost::edge(vda, vdb, g);
  BOOST_CHECK_THROW(
    remove_edge_between_vertices_with_names(a,c,g),
    std::invalid_argument
  );
}

BOOST_AUTO_TEST_CASE(remove_edge_between_vertices_with_names_where_there_is_no_edge)
{
  auto g = create_empty_undirected_named_edges_and_vertices_graph();
  const std::string a{"A"};
  const std::string b{"B"};
  ...
  BOOST_CHECK_THROW(
    remove_edge_between_vertices_with_names(a,b,g),
    std::invalid_argument
  );
}
