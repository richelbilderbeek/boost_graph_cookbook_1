...
created by two \verb;boost::add_vertex; \index{boost::add_vertex}
calls are stored to add an edge to the graph.
Then \verb;boost::add_edge; \index{boost::add_edge}
...
\begin{figure}[!htbp]
  ...
  \caption{
    .svg file created from the \verb;create_markov_chain; function 
    (algorithm \ref{lst:create_markov_chain_graph}) 
