...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{boost::add\_edge result}
...
\begin{figure}[!htbp]
  \includegraphics[]{create_k2_graph.svg}
...
\begin{figure}[!htbp]
  \includegraphics[]{create_k3_graph.svg}
  \caption{
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{$\triangle$ Creating a path graph}
...
\begin{figure}[!htbp]
  \includegraphics[]{Petersen_graph.svg}
  \caption{
    A Petersen graph 
...
\begin{figure}[!htbp]
  \includegraphics[]{create_petersen_graph.svg}
  \caption{
