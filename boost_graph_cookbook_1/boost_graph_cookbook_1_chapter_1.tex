...
Core C++ Guidelines \index{Core C++ Guidelines}.
...
no templated arguments \index{No templates} 
...
\index{Long function names}
\index{Readability, function name length}
...
When C++17 \index{C++17} 
gets accessible, 
I will use 
\verb;decltype(auto); \index{decltype}
...
\index{Namespaces}
\index{Explicit namespaces}
\index{Readability, explicit namespaces}
