...
Due to my long function names and the limitation of â50 characters per line,
...
\begin{figure}[!htbp]
  \includegraphics[]{CC-BY-SA_icon.svg}
  \caption{
...
\begin{figure}[!htbp]
  \includegraphics[]{create_tutorial_subchapters_graph.svg}
  \caption{
