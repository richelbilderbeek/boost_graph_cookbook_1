...
create_tutorial_chapters_graph() noexcept
{
  ...
  vertex_name_map[va] = "create_empty_graph";
  vertex_name_map[vb] = "create_named_vertices_graph";
  vertex_name_map[vc] = "create_named_edges_and_vertices_graph";

  //Add edge names
  edge_name_map_t edge_name_map{boost::get(boost::edge_name,g)};
  edge_name_map[eab.first] = "vertex name";
