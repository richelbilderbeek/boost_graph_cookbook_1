...
{
  //Create the picture 'load_undirected_named_edges_and_vertices_graph_from_dot_test_markov_chain.svg'
  ...
  //Create another graph by loading it, then save it to .dot, convert that .dot to .svg
  {
    ...
    const std::string svg_filename{"load_undirected_named_edges_and_vertices_graph_from_dot_test_markov_chain.svg"};
