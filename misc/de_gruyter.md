...
### A. SCHEDULE*: Please tell us when you will be able to submit the complete manuscript. 
### B. TYPE OF MANUSCRIPT:  

Which program do you use to prepare your manuscript?*
Word: _  LaTeX: _  Other: _

Which operating system do you use (please specify the version)?
Windows: _ Mac: _ Other: _

Would you like to submit your manuscript camera ready? If you choose this option, we will provide you with templates and our DG corporate font, and our production department will advise you in the event that you have questions or problems. You should only choose this option if you are confident in the procedure. 

Yes __ No___ 	
### C. ESTIMATED PAGE COUNT*, FIGURE COUNT, AND TABLE COUNT: Only the page count is included in the contract. 1 printed page = 2,800 characters including spaces without images (please use Word character count).
...
### D. INDEX: Your book should contain an index. We prefer that the index is created by you using the Word index tool. Please tell us here if you require any guidance. 
Yes: _ No: _

## THE MARKET FOR YOUR BOOK

### A. TARGET GROUPS*: Please tell us which target groups will be interested in your publication. Please specify target groups (scholars, students or professionals) (max. 125 character including spaces). 

If your book is written as a textbook, please indicate the level e.g., graduate or postgraduate. Do you envisage your textbook being used as a core book for a course or as supplementary reading? Also include the name of the course/ module where your book could be considered for adoption. 
### B. COMPETING PUBLICATIONS: Please name two to three potential competing publications and explain how your volume differs from these volumes. The publications mentioned should not be older than five years. 
...
Does your publication have any special requirements that we need to take into account during our planning (e.g., whether you need file copies, important deadlines to be met, etc.)?
