...
{
  {
    ...
    assert(has_bundled_vertex_with_my_vertex(my_vertex("A","source",0.0,0.0), g));
    const auto vd = find_first_bundled_vertex_with_my_vertex(my_vertex("A","source",0.0,0.0), g);
