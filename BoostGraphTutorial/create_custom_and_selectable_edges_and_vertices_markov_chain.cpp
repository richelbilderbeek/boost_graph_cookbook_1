//TODO: #include "create_nasty_directed_custom_and_selectable_edges_and_vertices_graph.h"
...
BOOST_AUTO_TEST_CASE(create_custom_and_selectable_edges_and_vertices_markov_chain_thorough)
{
  //Basic tests
  {
