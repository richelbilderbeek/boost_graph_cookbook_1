...
BOOST_AUTO_TEST_CASE(test_remove_first_vertex_with_name_for_vertex_that_does_not_exist)
{
  ...
  BOOST_CHECK_THROW(
    remove_first_vertex_with_name(name,g),
    std::invalid_argument
  );
}

BOOST_AUTO_TEST_CASE(test_remove_first_vertex_with_name_for_vertex_that_is_still_connected)
{
  auto g = create_named_vertices_k2_graph();
