...
create_tutorial_chapters_graph() noexcept
{
...

  {
    ...
    add_edge_between_named_vertices(s, std::string("Graphs with custom vertices"), g);
    add_edge_between_named_vertices(s, std::string("Graphs with a graph name"), g);
  }
  {
    const std::string s = "Graphs with named vertices";
    add_edge_between_named_vertices(s, std::string("Graphs with named edges and vertices"), g);
    add_edge_between_named_vertices(s, std::string("Graphs with bundled vertices"), g);
    add_edge_between_named_vertices(s, std::string("Graphs with custom vertices"), g);
    add_edge_between_named_vertices(s, std::string("Graphs with a graph name"), g);
  }
  ...
  }
  {
    ...
    add_edge_between_named_vertices(s, std::string("Graphs with named vertices"), g);
    add_edge_between_named_vertices(s, std::string("Graphs with bundled edges and vertices"), g);
    add_edge_between_named_vertices(s, std::string("Graphs with custom vertices"), g);
    add_edge_between_named_vertices(s, std::string("Graphs with a graph name"), g);
  }
  {
