...
#include "create_custom_and_selectable_edges_and_vertices_k2_graph_demo.impl"
...
void create_custom_and_selectable_edges_and_vertices_k2_graph_test() noexcept
{
  //Basic tests
  {
  ...
  //Create the .dot and .svg of the 'create_custom_and_selectable_edges_and_vertices_k2_graph' chapter
  {
    const auto g = create_custom_and_selectable_edges_and_vertices_k2_graph();
    const std::string base_filename{"create_custom_and_selectable_edges_and_vertices_k2_graph"};
  ...
  create_custom_and_selectable_edges_and_vertices_k2_graph_demo();
