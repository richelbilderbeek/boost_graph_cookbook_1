...
BOOST_AUTO_TEST_CASE(get_type_name_thorough)
{
  ...
  BOOST_CHECK(get_type_name<decltype(create_empty_undirected_named_vertices_graph())>()
  ...
  BOOST_CHECK(get_type_name<decltype(create_empty_undirected_named_edges_and_vertices_graph())>()
  ...
  BOOST_CHECK(get_type_name<decltype(create_empty_undirected_custom_vertices_graph())>()
  ...
  BOOST_CHECK(get_type_name<decltype(create_empty_undirected_custom_edges_and_vertices_graph())>()
  ...
  BOOST_CHECK(get_type_name<decltype(vertices(create_empty_undirected_graph()))>()
