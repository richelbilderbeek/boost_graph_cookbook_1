...
#include "create_custom_and_selectable_edges_and_vertices_path_graph.impl"
...
void create_custom_and_selectable_edges_and_vertices_path_graph_test() noexcept
{
  //Basic tests
  {
  ...
  create_custom_and_selectable_edges_and_vertices_path_graph_demo();
