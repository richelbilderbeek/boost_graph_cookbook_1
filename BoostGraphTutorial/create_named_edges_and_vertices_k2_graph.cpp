...
#include "create_named_edges_and_vertices_k2_graph.impl"

#include "create_empty_undirected_named_edges_and_vertices_graph.h"
#include "create_named_edges_and_vertices_k2_graph_demo.impl"
#include <cassert>
#include <iostream>
...
void create_named_edges_and_vertices_k2_graph_test() noexcept
{
  //Basic functions
  {
  ...
  //Create the create_named_edges_and_vertices_k2_graph .dot and .svg files
  {
    const auto g = create_named_edges_and_vertices_k2_graph();
    const std::string base_filename{"create_named_edges_and_vertices_k2_graph"};
  ...
  create_named_edges_and_vertices_k2_graph_demo();
