...
Algorithm \ref{alg:create_k3_graph_demo} demonstrates how to 'create\_k2\_graph'
and checks if it has the correct amount of edges and vertices:
...
Algorithm \ref{alg:create_path_graph_demo} demonstrates how to 'create\_k2\_graph'
and checks if it has the correct amount of edges and vertices:
...
\subsection{\textifsymbol[ifgeo]{100} Creating a Peterson graph\label{sub:create_petersen_graph}\index{Create Petersen graph}\index{Petersen graph, create}}
...
\caption{Demonstration of 'create\_k3\_graph' \label{alg:create_petersen_graph_demo}}
\end{algorithm}
...
\item Create all direct-neighbour subgraphs from a graphs
